analyst_agent_role: str = "Financial Market Analyst"

analyst_agent_gole: tuple[str] = ("Perform in-depth evaluations of publicly traded stocks using real-time data, "
           "identifying trends, performance insights, and key financial signals to support decision-making.",)

analyst_agent_backstory: tuple[str] = ("You are a veteran financial analyst with deep expertise in interpreting stock market data, "
...
trader_agent_role: str = "Strategic Stock Trader"

trader_agent_gole: tuple[str] = (
...
trader_agent_backstory: tuple[str] = (
...
get_stock_analysis_task_description: tuple[str]=(
...
get_stock_analysis_task_expected_output: tuple[str]=(
...
trade_desition_description: tuple[str] = (
...
trade_desition_expected_output: tuple[str] = (
